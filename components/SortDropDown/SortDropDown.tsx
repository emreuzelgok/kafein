...
const SortDropDown:FC<SortDropDownProps> = ({}) => {
  ...
  return (
    <DropDown primary label={selected}>
      <button className="sort-drop-down__item" onClick={sortByAscAction}>Title A-Z</button>
      <button className="sort-drop-down__item" onClick={sortByDescAction}>Title Z-A</button>
    </DropDown>
  );
}
